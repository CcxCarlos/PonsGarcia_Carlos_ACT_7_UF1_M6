...
public class GridLayoutActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViews[0] = findViewById(R.id.txtGrid);
        textViews[1] = findViewById(R.id.txtGrid2);
        textViews[2] = findViewById(R.id.txtGrid3);
        textViews[3] = findViewById(R.id.txtGrid4);
        textViews[4] = findViewById(R.id.txtGrid5);
        textViews[5] = findViewById(R.id.txtGrid6);
        textViews[6] = findViewById(R.id.txtGrid7);

        switchButton = findViewById(R.id.switchButtonGrid);
        toggleButton = findViewById(R.id.toggleButtonGrid);
        imageButton = findViewById(R.id.imgGrid);
        view = this.getWindow().getDecorView();
        defaultColor = getColor(R.color.cian);

        imageButtons[0] = findViewById(R.id.buttonGridLayoutBack);
        imageButtons[1] = findViewById(R.id.buttonGridLayoutForward);
    ...
    public void switchAct(View view){
        switch (view.getId()){
            case R.id.buttonGridLayoutBack:
                finish();
                break;
            case R.id.buttonGridLayoutForward:
