...
public class TableLayoutActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViews[0] = findViewById(R.id.txtTable);
        textViews[1] = findViewById(R.id.txtTable2);
        textViews[2] = findViewById(R.id.txtTable3);
        textViews[3] = findViewById(R.id.txtTable4);
        textViews[4] = findViewById(R.id.txtTable5);
        textViews[5] = findViewById(R.id.txtTable6);
        textViews[6] = findViewById(R.id.txtTable7);

        switchButton = findViewById(R.id.switchButtonTable);
        toggleButton = findViewById(R.id.toggleButtonTable);
        imageButton = findViewById(R.id.imgTable);
        view = this.getWindow().getDecorView();
        defaultColor = getColor(R.color.cian);

        imageButtons[0] = findViewById(R.id.buttonTableLayoutBack);
        imageButtons[1] = findViewById(R.id.buttonTableLayoutForward);
    ...
    public void switchAct(View view){
        switch (view.getId()){
            case R.id.buttonTableLayoutBack:
                finish();
                break;
            case R.id.buttonTableLayoutForward:
