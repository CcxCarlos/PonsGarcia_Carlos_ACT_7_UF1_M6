...
public class DosLayoutActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dos_layout);

        textViews[0] = findViewById(R.id.txtDos);
        textViews[1] = findViewById(R.id.txtDos2);
        textViews[2] = findViewById(R.id.txtDos3);
        textViews[3] = findViewById(R.id.txtDos4);
        textViews[4] = findViewById(R.id.txtDos5);
        textViews[5] = findViewById(R.id.txtDos6);
        textViews[6] = findViewById(R.id.txtDos7);

        switchButton = findViewById(R.id.switchButtonDos);
        toggleButton = findViewById(R.id.toggleButtonDos);
        imageButton = findViewById(R.id.imgDos);
        view = this.getWindow().getDecorView();
        defaultColor = getColor(R.color.cian);

        imageButtons[0] = findViewById(R.id.buttonDosLayoutBack);
        imageButtons[1] = findViewById(R.id.buttonDosLayoutForward);
    ...
    private void darkModeOff() {
        ...
        for (TextView t : textViews) {
            t.setTextColor(getColor(R.color.blue));
        }
    ...
    public void switchAct(View view){
        switch (view.getId()){
            case R.id.buttonDosLayoutBack:
                finish();
                break;
            case R.id.buttonDosLayoutForward:
