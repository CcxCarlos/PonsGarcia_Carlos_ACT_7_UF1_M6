...
public class FrameLayoutActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.txtFrame);

        switchButton = findViewById(R.id.switchButtonFrame);
        toggleButton = findViewById(R.id.toggleButtonFrame);
        imageButton = findViewById(R.id.imgFrame);
        view = this.getWindow().getDecorView();
        defaultColor = getColor(R.color.cian);
        imageButtons[0] = findViewById(R.id.buttonFrameLayoutBack);
        imageButtons[1] = findViewById(R.id.buttonFrameLayoutForward);
    ...
    public void switchAct(View view){
        switch (view.getId()){
            case R.id.buttonFrameLayoutBack:
                finish();
                break;
            case R.id.buttonFrameLayoutForward:
